...
String sql ="select * from Tariffht2ci";
...
%>
    <tr>
      ...
      <td><a href="EditTariff2ci.jsp?from1=<%=resultSet.getString("from1")%>" style="color:black;font-weight:bold"><button type="button" class="btn btn-warning" >EDIT</button></a></td>
    </tr>
     </tbody>
     <%
}
