...
<div class="row" style=" margin-left: 23px;margin-top: 89px;">
  ...
  String sql ="select * from tariffht2cii";
  ...
  %>
    <tr>
     ...
     <td><a href="EditTariff2cii.jsp?from1=<%=resultSet.getString("from1")%>" style="color:black;font-weight:bold"><button type="button" class="btn btn-warning" >EDIT</button></a></td>
    </tr>
