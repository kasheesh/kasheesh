...
String sql ="select * from tariffht4";
...
%>
    ...
    <td><%=resultSet.getString("from1") %></td>
     ...
     <td><a href="EditTariffHT4.jsp?from1=<%=resultSet.getString("from1")%>" style="color:black;font-weight:bold"><button type="button" class="btn btn-warning" >EDIT</button></a></td>
    </tr>
    <tr>
