...
String sql ="select * from tarifflt2ai";
...
%>
    <tr>
      ...
      <td><%=resultSet.getString("rate") %></td>
       <td><a href="EditTariff2ai.jsp?from1=<%=resultSet.getString("from1")%>" style="color:black;font-weight:bold"><button type="button" class="btn btn-warning" >EDIT</button></a></td>
