...
String sql ="select * from Tarifflt2aii";
...
%>
    <tr>
      ...
      <td><a href="EditTariff2aii.jsp?from1=<%=resultSet.getString("from1")%>" style="color:black;font-weight:bold"><button type="button" class="btn btn-warning" >EDIT</button></a></td>
    </tr>
   <%
}
connection.close();
