...
String sql ="select * from tarifflt2bi";
...
%>
 ...
 <td><a href="EditTariff2bi.jsp?from1=<%=resultSet.getString("from1")%>" style="color:black;font-weight:bold"><button type="button" class="btn btn-warning" >EDIT</button></a></td>
    </tr>
  <%
}
connection.close();
