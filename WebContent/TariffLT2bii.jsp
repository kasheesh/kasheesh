...
String sql ="select * from Tarifflt2bii";
...
%>
    <tr>
     ...
     <td><a href="EditTariff2bii.jsp?from1=<%=resultSet.getString("from1")%>" style="color:black;font-weight:bold"><button type="button" class="btn btn-warning" >EDIT</button></a></td>
    </tr>
    <%
}
connection.close();
